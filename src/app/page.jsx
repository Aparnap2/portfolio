...
export const Section = ({ id, title, children, className }) => {
  return (
    <section id={id} className={`w-full max-w-7xl mx-auto px-8 py-20 ${className}`}>
...
export default function Home() {
  ...
  const AboutContent = () => (
    <div className="backdrop-blur-lg bg-gray-900/40 rounded-2xl shadow-2xl border border-gray-800/50 p-12">
      ...
      <div className="mt-12 text-center">
        <p className="text-xl font-geist-sans text-gray-100 mb-6">Let&apos;s build something amazing together!</p>
      </div>
    </div>
  );
  ...
  return (
    ...
    <div  ref={chatboxRef} className="bg-gradient-to-bl from-orange-900 via-gray-900 to-purple-900 min-h-screen flex flex-col items-center text-white relative overflow-hidden">
      {/* Navigation */}
      ...
      <header className="w-full max-w-7xl mx-auto px-8 pt-40 pb-24 relative z-10">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12">
          ...
          <div className="text-center lg:text-left lg:pt-8">
            <h1 className="text-5xl font-geist-sans font-bold mb-6 bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text">
              Aparna Pradhan
            </h1>
            <div className="h-20 overflow-hidden mb-6">
              <p className="text-xl md:text-3xl font-geist-mono text-gray-300">
                <Typewriter
                  words={[
